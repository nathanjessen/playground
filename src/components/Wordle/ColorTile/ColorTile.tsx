...
export const ColorTile = ({ color = "base", children }: PropsWithChildren<IColorTile>) => {
  ...
  return (
    <div className={["text-4xl border-2 p-4 h-20 w-20 flex justify-center items-center uppercase", colors[color]].join(' ')}>
      {children}
    </div>
  );
};
