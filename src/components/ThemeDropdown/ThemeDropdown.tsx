                  ...
                  <>
                    <div className='flex gap-2 justify-between'>
                      ...
                      <div className='flex gap-1'>
                        <span className='block w-3 h-5 bg-primary'></span>
                        <span className='block w-3 h-5 bg-secondary'></span>
                        <span className='block w-3 h-5 bg-accent'></span>
                        <span className='block w-3 h-5 bg-neutral'></span>
                      </div>
                    </div>
                    {selected ? (
